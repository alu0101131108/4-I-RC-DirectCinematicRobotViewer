...
#    1        2     2'   3       4        51       52             
d  = [p[0],   0,    0,  p[2],   0,       0,       0]
th = [   0,p[1],  -90,   -90,p[3],270+p[4],270-p[4]]
a  = [   0,   5,    0,     0,   0,       2,       2]
al = [   0,   0,  -90,     0, -90,       0,       0]

# Orígenes para cada articulación. oij será el origen i en el sistema de referencia j.
o00=[0,0,0,1]
o11=[0,0,0,1]
o22=[0,0,0,1]
o2p2p=[0,0,0,1]
...
# Cálculo matrices transformación. Tij pasa del sistema j al sistema i.
...
# Cálculo matrices de transformacion del eje i al 0.
T01=T01
T02=np.dot(T01,T12)
...
# Transformación de cada articulación. Multiplicacion del punto (Oij) y matriz de traslacion (Tkl).
...
muestra_origenes([o00, o10, o20, o2p0, o30, o40, [[o510], [o520]] ])
muestra_robot   ([o00, o10, o20, o2p0, o30, o40, [[o510], [o520]] ], ef0)
